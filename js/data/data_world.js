...
const TERRAIN_ZONES = [
    ...
    /* === 6. 大海 (边缘) === */
    // 东海
    { type: "ocean", name: "东海", x: [1800, 2700], y: [1200, 1800] },
    // 南海
    { type: "ocean", name: "南海", x: [1000, 2700], y: [2000, 2700] },
    // 渤海
...
const WORLD_TOWNS_PART_1 = [
    ...
    // 雍城 (West of Xianyang) - Spaced > 80px
    ...
    // 郿县 (South of Yong)
    { id: "t_meixian",  name: "郿县", level: "village", x: 1200, y: 1440, w: 30, h: 30, desc: "白起故里，民风彪悍。" },
    // 醴泉 (North of Xianyang)
    { id: "t_liquan",   name: "醴泉", level: "village", x: 1300, y: 1270, w: 30, h: 30, desc: "甘泉宫所在，避暑胜地。" },

    // === 2. 豫州/三晋 (East of Guanzhong) ===
    // 函谷关 (East of Xianyang)
...
const WORLD_TOWNS_PART_2 = [
    ...
    // 赤壁 (East of Ying)
    { id: "t_chibi",    name: "赤壁", level: "village", x: 1450, y: 1620, w: 30, h: 30, desc: "长江险隘，后世火烧连营处。" },
    // 襄阳 (North West of Ying)
    ...
    // 豫章 (West of Wu/South of Shouchun)
    ...
    // 阆中 (Between Hanzhong and Chengdu)
    // 剑门 (North of Chengdu)
    { id: "t_jianmen",  name: "剑门", level: "village", x: 1050, y: 1480, w: 30, h: 30, desc: "蜀道难，难于上青天，剑门天下险。" },
    // 自贡 (South of Chengdu)
    { id: "t_zigong",   name: "自贡", level: "village", x: 1050, y: 1650, w: 30, h: 30, desc: "千年盐都，井盐之源。" },

    // === 7. 岭南/西南 (Far South) ===
    // 番禺 (South East)
    { id: "t_panyu",    name: "番禺", level: "city", x: 1450, y: 2000, w: 60, h: 60, desc: "岭南都会，海上丝路起点，广州。" },
    // 桂林 (North West of Panyu)
    { id: "t_guilin",   name: "桂林", level: "town", x: 1300, y: 1900, w: 40, h: 40, desc: "山水甲天下，灵渠沟通湘漓。" },
    // 苍梧 (Between Guilin and Panyu)
...
const WORLD_TOWNS_PART_3 = [
    ...
    // 扶余 (North of Xiangping)
    { id: "t_fuyu",     name: "扶余", level: "town", x: 1900, y: 1000, w: 40, h: 40, desc: "东北古国，松嫩平原。" },
    // 鲜卑山 (West of Fuyu)
    { id: "t_xianbei",  name: "鲜卑山", level: "village", x: 1750, y: 950, w: 30, h: 30, desc: "鲜卑族发源地，大兴安岭深处。" },
    // 肃慎 (Far East)
    { id: "t_sushen",   name: "肃慎", level: "village", x: 2000, y: 1050, w: 30, h: 30, desc: "白山黑水，女真先祖。" },
    // 王险城 (South of Xiangping)
    ...
    // 狼居胥 (North of Longcheng)
    { id: "t_langjuxu", name: "狼居胥", level: "village", x: 1300, y: 550, w: 30, h: 30, desc: "霍去病封狼居胥，大漠深处。" },
    // 北海 (Far North)
    { id: "t_beihai",   name: "北海", level: "village", x: 1400, y: 300, w: 30, h: 30, desc: "苏武牧羊十九年，贝加尔湖。" },
    // 燕然山 (West of Longcheng)
    { id: "t_yanran",   name: "燕然山", level: "village", x: 1100, y: 650, w: 30, h: 30, desc: "勒石燕然，汉家威名。" },
...
const WORLD_TOWNS_PART_4 = [
    ...
    // 武威 (West of Guanzhong)
    { id: "t_wuwei",    name: "武威", level: "town", x: 950, y: 1300, w: 40, h: 40, desc: "凉州重镇，霍去病击败匈奴休屠王处，铜奔马出土地。" },
    // 张掖 (West of Wuwei)
    ...
    // 敦煌 (West of Jiuquan - Hub)
    { id: "t_dunhuang", name: "敦煌", level: "town", x: 680, y: 1250, w: 50, h: 50, desc: "西出阳关无故人，莫高窟，丝路西端枢纽。" },
    // 玉门关 (North West of Dunhuang)
    { id: "t_yumenguan",name: "玉门关", level: "village", x: 620, y: 1200, w: 30, h: 30, desc: "羌笛何须怨杨柳，春风不度玉门关。" },
    // 阳关 (South West of Dunhuang)
    { id: "t_yangguan", name: "阳关", level: "village", x: 620, y: 1300, w: 30, h: 30, desc: "劝君更尽一杯酒，西出阳关无故人。" },
    ...
    // 尼雅 (West of Qiemo)
    { id: "t_niya",     name: "尼雅", level: "village", x: 380, y: 1400, w: 30, h: 30, desc: "精绝古城，五星出东方利中国。" },
    // 于阗 (West of Niya)
